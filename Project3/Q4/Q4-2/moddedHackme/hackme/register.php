...
<div class="post">
	<div class="post-bgtop">
		...
		{
			$username = mysql_real_escape_string($_POST['uname']);//Input Sanitisation
			$firstname = mysql_real_escape_string($_POST['fname']);
			$lastname = mysql_real_escape_string($_POST['lname']);
			mysql_query("INSERT INTO users (username, pass, fname, lname) VALUES ('".$username."', '". $passwordHash ."', '". $firstname."', '". $lastname."');")or die(mysql_error());
