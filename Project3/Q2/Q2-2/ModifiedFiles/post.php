...
// Connects to the Database 
	...
	if (isset($_POST['post_submit'])) {
		...
		$convertedMsg = htmlspecialchars($_POST['message'], ENT_QUOTES);
		mysql_query("INSERT INTO threads (username, title, message, date) VALUES('".$_COOKIE['hackme']."', '". $_POST['title']."', '". $convertedMsg ."', '".time()."')")or die(mysql_error());
